export class PageConfig {
	public defaults: any = {
		dashboard: {
			page: {
				'title': 'Dashboard',
				'desc': 'Ultimele statistici și actualizări'
			},
		},
		ngbootstrap: {
			accordion: {
		...
		header: {
			actions: {
				page: {title: 'Acțiuni', desc: 'Exemple de acțiuni'}
			}
		},
		profile: {
			page: {title: 'Profil utilizator', desc: ''}
		},
		error: {
			404: {
				page: {title: '404 Pagina nu a fost gasită', desc: '', subheader: false}
			},
			403: {
				page: {title: '403 Accesul este interzis', desc: '', subheader: false}
			}
		},
		wizard: {
		...
		administrator: {
			page: {title: 'Încarcă, editează și salvează cărți', desc: 'Manager de cărți'}
		},
		user: {
			page: {title: 'Caută și filtrează cărți', desc: 'Manager de cărți'}
		}
	};
